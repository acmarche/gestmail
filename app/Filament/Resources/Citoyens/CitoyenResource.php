...
use App\Filament\Resources\Citoyens\Pages\ViewCitoyen;
use App\Filament\Resources\Citoyens\Schemas\CitoyenForm;
use App\Filament\Resources\Citoyens\Schemas\CitoyenInfolist;
...
final class CitoyenResource extends Resource
{
    ...
    {
        return CitoyenInfolist::configure($schema);
    }
